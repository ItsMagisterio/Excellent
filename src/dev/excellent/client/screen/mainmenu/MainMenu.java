...
public class MainMenu extends Screen implements IAccess, IMouse {
    ...
    private void renderFooter(MatrixStack matrixStack) {
        ...
        Fonts.INTER_BOLD.get(12).draw(matrixStack, "Made by " + TextFormatting.WHITE + "Bodya?*" , 3, scaled().y - Fonts.INTER_BOLD.get(12).getHeight() - 2, color);
        Fonts.ICON.get(10).draw(matrixStack, Icon.HEART.getCharacter(), 3 + Fonts.INTER_BOLD.get(12).getWidth("Made by " + TextFormatting.WHITE + "Bodya?*") + 2, scaled().y - Fonts.INTER_BOLD.get(12).getHeight() - 0.5F, ColorUtil.replAlpha(Color.RED.brighter().hashCode(), alpha));
